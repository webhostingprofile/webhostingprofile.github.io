...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-16 pt-[120px] dark:bg-pink md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
                style={{
                  
          backgroundImage: "url('/images/girlImage4.png')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          boxShadow: "20px 20px 20px rgba(255, 255, 255, 0.5)",
        }}
      >
        <div className="container">
          ...
          <div className="text-center pr-2 ">
            ...
            <span className="block text-sm text-black dark:text-white" style={{ fontWeight: 'bold' }}>GROWTH MANAGEMENT</span>
          </div>
          <div className="text-center pl-2">
            <UsersIcon className="mx-auto mt-8 mb-2 h-6 w-6" />
            <span className="block text-sm text-black dark:text-white" style={{ fontWeight: 'bold' }}>ACCOUNT MANAGEMENT</span>
          </div>
        </div>
                </div>
              </div>
        ...
        {/* <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100 ">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#F3BE05" />
                <stop offset="1" stopColor="#F3BE05" stopOpacity="0" />
              </linearGradient>
              <radialGradient
              ...
              >
                <stop offset="0.145833" stopColor="#F3BE05" stopOpacity="0" />
                <stop offset="1" stopColor="#F3BE05" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
